...
public class RouteController {
    ...
    private AStarConfiguration aStarConfiguration;
	...
	public RouteController(RouteService routeService, Button displayButton, Button hideButton,
						   ...
						   AStarConfiguration aStarConfiguration) {
        // save parameters
        ...
        this.aStarConfiguration = aStarConfiguration;
	...
	private void setupDisplayButtons() {
		displayButton.setOnAction(e -> {
            if(startLabel.getItem() != null && endLabel.getItem() != null) {
        			routeService.displayRoute(startLabel.getItem(), endLabel.getItem(), selectedToggle, aStarConfiguration);
            }
            else {
